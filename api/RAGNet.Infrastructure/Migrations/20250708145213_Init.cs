    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VectorStorages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApiKey = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProviderApiKeys_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduledPlan = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastEmbeddedDocumentDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastQueryDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ConversationProvider = table.Column<int>(type: "integer", nullable: false),
                    ConversationModel = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "VectorStorageMetas",
                columns: table => new
                {
                    Key = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    VectorStorageId = table.Column<Guid>(type: "uuid", nullable: false),
                    Value = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VectorStorageMetas", x => new { x.VectorStorageId, x.Key });
                    table.ForeignKey(
                        name: "FK_VectorStorageMetas_VectorStorages_VectorStorageId",
                        column: x => x.VectorStorageId,
                        principalTable: "VectorStorages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CallbackUrls_Workflows_workflow_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkflowId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    MaxItems = table.Column<int>(type: "integer", nullable: false, defaultValue: 5),
            ...
            migrationBuilder.CreateTable(
                name: "VectorStorageConfigs",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    CollectionId = table.Column<Guid>(type: "uuid", nullable: false),
                    VectorDimension = table.Column<long>(type: "bigint", nullable: false),
                    WorkflowId = table.Column<Guid>(type: "uuid", nullable: false),
                    VectorStorageId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VectorStorageConfigs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VectorStorageConfigs_VectorStorages_VectorStorageId",
                        column: x => x.VectorStorageId,
                        principalTable: "VectorStorages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VectorStorageConfigs_Workflows_WorkflowId",
                        column: x => x.WorkflowId,
                        principalTable: "Workflows",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChunkerMetas", x => new { x.ChunkerId, x.Key });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilterMetas", x => new { x.FilterId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QueryEnhancerMetas", x => new { x.QueryEnhancerId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RankerMetas", x => new { x.RankerId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CallbackUrls_workflow_id",
                table: "CallbackUrls",
                column: "workflow_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProviderApiKeys_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VectorStorageConfigs_VectorStorageId",
                table: "VectorStorageConfigs",
                column: "VectorStorageId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VectorStorageConfigs_WorkflowId",
                table: "VectorStorageConfigs",
                column: "WorkflowId",
                unique: true);
